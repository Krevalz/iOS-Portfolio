...
class CreateAccountVC: UIViewController {
    ...
    @IBAction func createAccoundPressed(_ sender: Any) {
        guard let name = usernameFld.text, usernameFld.text != "" else {return}
        guard let email = emailFld.text, emailFld.text != "" else {return}
        guard let pass = passwordFld.text, passwordFld.text != "" else {return}
